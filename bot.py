...
# -*- coding: utf-8 -*-
"""
Kino Bot - To'liq tuzatilgan versiya
Tuzatishlar:
  1. kb_main ga "Videolar" tugmasi qo'shildi
  2. MENU_BUTTONS ga "Videolar" va "Видео" qo'shildi
  3. Hisobni to'ldirishda karta raqami FAQAT matn sifatida yuboriladi (rasm emas)
  4. Video to'lovda ham karta raqami matn sifatida
  5. send_topup_chk va send_check xabarlarida parse_mode olib tashlandi (xavfsiz)
"""
...
T = {
    'uz': {
        ...
        'btn_share'      : "Ulashish",
        'btn_close'      : "Yopish",
        # ✅ FIX: karta raqami oddiy matn sifatida, HTML teglarsiz
...
# ✅ FIX 1: "Videolar" tugmasi qo'shildi
...
# ─────────── Videolar ───────────
# ✅ FIX 2: MENU_BUTTONS ga "Videolar" va "Видео" qo'shildi
MENU_BUTTONS = {
    "Videolar", "Видео",
    "Hisobim", "Мой счёт",
    "Yordam", "Помощь",
...
async def cb_paycard(call: CallbackQuery, state: FSMContext):
    ...
    # ✅ FIX 3: parse_mode=None — karta raqami matn sifatida chiqadi, rasm emas
...
async def rx_topup_amount(msg: Message, state: FSMContext):
    ...
    # ✅ FIX 4: parse_mode yo'q — karta raqami oddiy matn sifatida chiqadi
